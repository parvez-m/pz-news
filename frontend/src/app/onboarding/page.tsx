...
const SUGGESTIONS: Record<SugTab, { label: string; type: TopicType }[]> = {
  ...
  channels: [
    { label: "https://www.youtube.com/@lexfridman",        type: "youtube_channel" },
    { label: "https://www.youtube.com/@kurzgesagt",        type: "youtube_channel" },
    { label: "https://www.youtube.com/@veritasium",        type: "youtube_channel" },
    { label: "https://www.youtube.com/@3blue1brown",       type: "youtube_channel" },
    { label: "https://www.youtube.com/@ycombinator",       type: "youtube_channel" },
    { label: "https://www.youtube.com/@TED",               type: "youtube_channel" },
    { label: "https://www.youtube.com/@Fireship",          type: "youtube_channel" },
    { label: "https://www.youtube.com/@TwoMinutePapers",   type: "youtube_channel" },
    { label: "https://www.youtube.com/@RealEngineering",   type: "youtube_channel" },
  ],
  playlists: [
